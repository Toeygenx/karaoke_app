      ...
      {currentSong ? (
        ...
        <div className="w-full h-full flex flex-col items-center justify-center text-gray-500 bg-surface relative overflow-hidden group">
          ...
          <div className="z-10 flex flex-col items-center">
            <div className="w-20 h-20 rounded-full bg-surface-border/50 border border-surface-border flex items-center justify-center mb-6 group-hover:shadow-[0_0_40px_rgba(59,130,246,0.2)] group-hover:scale-110 transition-all duration-500">
